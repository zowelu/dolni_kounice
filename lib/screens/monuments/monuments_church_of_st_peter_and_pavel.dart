...
class MonumentsChurchOfStPeterAndPavel extends StatelessWidget {
  static String id = ChurchOfStPeterAndPavel().id;
  static ChurchOfStPeterAndPavel churchOfStPeterAndPavel = ChurchOfStPeterAndPavel();
  @override
  Widget build(BuildContext context) {
    return MonumentsPage(
      assetImage: churchOfStPeterAndPavel.imageGallery[0],
      textOfAppBar: 'Průvodce památkami',
      textHeader: churchOfStPeterAndPavel.name,
      ...
      listOfWidget: [
        ...
        ChoiceContainer(
            assetImageOfChoice: churchOfStPeterAndPavel.imageGallery[1],
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => GalleryPhotoViewPage(
                    nameOfImageGallery: churchOfStPeterAndPavel.nameOfImageGallery,
                  ),
                ),
              );
            }),
        ...
        Center(
          child: MyButton(
            ...
            onPressed: () async {
              ...
              OpenUrlInBrowser().openUrl(churchOfStPeterAndPavel.url);
            },
          ),
        ),
        SizedBox(
