    ...
    return MonumentsPage(
      ...
      listOfWidget: [
        ...
        MiddleClassHouse(
          ...
          imageIndex: 5,
          text:
              'V současnosti uzavřená pizzérie. Tento jeden z nejstarších domů byl vystaven roku 1590 tehdejším starostou Dolních Kounic - Janem Tišnovským z Cineperku. V domě bylo například: řeznictví, Denkova hospoda, smíšené zboží a donedávna pizzerie.',
        ),
        MiddleClassHouse(
          adress: 'Hlavní 6',
          imageIndex: 6,
